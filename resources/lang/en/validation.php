...
return [
    ...
    'unique_phone' => 'Phone is already in use.',
    ...
    'custom' => [
        'phone' => [
            'not_valid' => 'The value [:value] must be a valid phone number!'
        ],
        'attribute-name' => [
        ...
        'name' => [
            'name_rule' => 'Argument :attribute should contains from 2 to 250 symbols'
        ],
        'forward_number' => [
        ...
        'translations' => [
            'not_contain_supporting_lang' => 'Translations do not contain supported languages'
        ],
        'permissions' => [
            'contain_not_valid' => 'There are invalid permissions in the transmitted permissions',
            'role_name_not_unique' => 'For this guard, the role name is not unique',
        ]
    ],
